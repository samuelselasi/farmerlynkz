...
@router.get("/staff/")
async def read_staff(token:str, db:Session=Depends(get_db)):
...
@router.get("/{name}/")
async def read_staff_by_name(name:str, token:str, db:Session=Depends(get_db)):
...
@router.get("/roles/")
async def read_roles(token:str, db:Session=Depends(get_db)):
...
async def deactivate_staff(staff_id:int, token:str, db:Session=Depends(get_db)):
...
@router.post("/staff/")
async def create_staff(payload:schemas.UserCreate, token:str, db:Session=Depends(get_db)):
...
@router.post("/roles/")
async def create_roles(payload:schemas.create_roles, token:str, db:Session=Depends(get_db)):
...
@router.put("/staff/")
async def update_staff(payload:schemas.update_staff, token:str, db:Session=Depends(get_db)):
...
@router.put("/roles/")
async def update_roles(payload:schemas.update_roles, token:str, db:Session=Depends(get_db)):
...
async def delete_staff(staff_id:int, token:str, db:Session=Depends(get_db)):
...
async def delete_roles(role_id:int, tken:str, db:Session=Depends(get_db)):
