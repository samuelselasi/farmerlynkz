...
async def create_competency_details(payload: schemas.create_competence_details, appraisal_form_id: int, submit: int, competency_id=1, grade=1, db: Session = Depends(get_db)):
